...
export const freeSelf = typeof self === 'object' && self !== null && self.Object === Object && self
...
export const stringifyProp = (data: unknown): string => JSON.stringify(data).replace(/'/g, '&#39')
...
export const endsWith = (str: unknown, suffix: string): boolean => isString(str) && str.endsWith(suffix)
...
export const isRelativeLink = (link: string) => /^(?!www\.|http[s]?:\/\/|[A-Za-z]:\\|\/\/).*/.test(link)
