...
<template>
	<div class="banner" v-if="open && isHomePage">
		<p class="vt-banner-text">
			...
			<a target="_blank" class="vt-primary-action" href="/ssu/defense"> 解释与说明 </a>
		</p>
...
html.banner-visible {
	--vp-nav-height-desktop: calc(var(--vp-nav-height-desktop, 72px) + var(--vt-banner-height));
	--vp-nav-height-mobile: calc(var(--vp-nav-height-mobile, 56px) + var(--vt-banner-height));
}
</style>
