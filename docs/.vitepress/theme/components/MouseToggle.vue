<!-- 鼠标特效开关组件 -->
<template>
	<div class="mouse-effects-switch" :class="{'mouse-effects-enabled': isEnabled}">
		<button
			class="toggle"
		...
		<div id="mouse-effects-switches" :hidden="!isOpen" :aria-hidden="!isOpen">
			<div class="switch-container">
				<label class="disabled-label" @click="toggleMouseEffects(false)">关闭</label>
				<VTSwitch
					class="effects-switch"
					aria-label="toggle mouse effects"
					:aria-checked="isEnabled"
					@click="toggleMouseEffects()" />
				<label class="enabled-label" @click="toggleMouseEffects(true)">开启</label>
